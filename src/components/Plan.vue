<template>
  <div id="planos" class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-8 mx-auto">
      ...
      <p class="max-w-2xl mx-auto mt-4 text-center text-gray-500 xl:mt-6 dark:text-gray-300">
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias quas magni libero
        consequuntur voluptatum velit amet id repudiandae ea, deleniti laborum in neque eveniet.
      </p>

      <div class="flex-1 xl:mx-8 xl:mt-12">
        <div
        ...
        >
          ...
          <div class="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
            <div class="p-6">
              ...
              <h2 class="mt-4 text-2xl font-semibold text-gray-700 sm:text-3xl dark:text-gray-300">
                $7.00 <span class="text-base font-medium">/Month</span>
              </h2>
